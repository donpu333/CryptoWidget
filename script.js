Вот исправленный и полностью рабочий код JavaScript. Основная проблема была в неполном сбросе состояния формы после создания алерта, что мешало созданию новых алертов без перезагрузки страницы.
